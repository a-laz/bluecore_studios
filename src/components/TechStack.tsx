...
const technologies: Tech[] = [
  ...
  { name: "Angular", Icon: SiAngular, categories: ["Frontend"], color: "#DD0031" },
  { name: "Next.js", Icon: SiNextdotjs, categories: ["Frontend"], color: "#E2E8F0" },
  ...
  { name: "React Native", Icon: SiReact, categories: ["Mobile"], color: "#61DAFB" },
  { name: "Flutter", Icon: SiFlutter, categories: ["Mobile"], color: "#02569B" },
  { name: "Docker", Icon: SiDocker, categories: ["DevOps"], color: "#2496ED" },
  { name: "Kubernetes", Icon: SiKubernetes, categories: ["DevOps"], color: "#326CE5" },
  { name: "GCP", Icon: SiGooglecloud, categories: ["DevOps"], color: "#4285F4" },
  { name: "AWS", Icon: SiAmazonwebservices, categories: ["DevOps"], color: "#FF9900" },
